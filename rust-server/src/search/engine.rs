...
impl SearchEngine {
    ...
    /// Create a search engine with custom scoring weights
        ...
        F: Fn(&T) -> Vec<String>,
    {
        ...
        results.sort_by(|a, b| {
            b.score.final_score.partial_cmp(&a.score.final_score)
    ...
    fn match_text(&mut self, needle: &str, haystacks: &[String]) -> Option<MatchScore> {
        ...
        for haystack in haystacks {
            ...
            if let Some(fuzzy_match) = self.fuzzy_matcher.fuzzy_match(haystack, needle) {
                let proximity_score = self.fuzzy_matcher.calculate_proximity_score(&fuzzy_match.positions);
...
mod tests {
    ...
    fn test_search_basic() {
        ...
        let posts = vec![
            ...
            TestPost { text: "Goodbye world".to_string() },
            TestPost { text: "Hello there".to_string() },
        ];
    ...
    fn test_search_quoted() {
        ...
        let posts = vec![
            TestPost { text: "Hello world".to_string() },
            TestPost { text: "Hello there world".to_string() },
            TestPost { text: "World hello".to_string() },
        ];
    ...
    fn test_search_stop_words() {
        ...
        let posts = vec![
            TestPost { text: "The cat sat on the mat".to_string() },
            TestPost { text: "A dog ran".to_string() },
        ];
    ...
    fn test_search_fuzzy() {
        ...
        let posts = vec![
            TestPost { text: "programming".to_string() },
            TestPost { text: "programmer".to_string() },
            TestPost { text: "program".to_string() },
        ];
    ...
    fn test_search_ranking() {
        ...
        let posts = vec![
            TestPost { text: "car".to_string() },           // Full word match
            TestPost { text: "carton".to_string() },        // Beginning of word
            TestPost { text: "scar".to_string() },          // End of word
            TestPost { text: "scary".to_string() },         // Middle of word
        ];
