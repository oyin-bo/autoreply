...
mod tests {
    ...
    fn test_repository_provider_new() {
        ...
        assert!(provider.cache_dir.exists(), "Cache directory should be created");
    ...
    fn test_repository_provider_default() {
        ...
        assert!(provider.cache_dir.exists(), "Default provider should have cache dir");
    }
    ...
    fn test_cache_dir_in_correct_location() {
        ...
        assert!(
            cache_path.contains("AppData") || cache_path.contains("cache") || cache_path.contains("tmp"),
    ...
    fn test_temp_filename_generation() {
        ...
        assert_ne!(cache_filename, temp_filename, "Temp and final filenames must differ");
    }
    ...
    async fn test_fetch_repo_car_unsupported_did_method() {
        ...
        let result = provider.fetch_repo_car("did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK").await;
    ...
    fn test_cache_path_structure() {
        ...
        assert!(!path_str.contains(':'), "Filename should not contain colons");
    }
    ...
    async fn test_records_with_cached_car() {
        ...
        assert!(result.is_ok() || result.is_err(), "Should attempt to parse CAR");
    }
}
